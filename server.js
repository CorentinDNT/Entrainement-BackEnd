//require est la commande pour importer un package node.js
...
//cette méthode prends comme argument la fonction qui sera appelé sur chaque requete du serveur
//normalement http.createServer((req, res) => {})
